...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: "GitHub",
      url: "https://github.com/Lier0102/new-blog", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: "Bankai",
  bio: "Astro와 GitHub Pages로 운영하는 개인 블로그입니다.",
  links: [
    {
      name: "GitHub",
      icon: "fa6-brands:github",
      url: "https://github.com/Lier0102/new-blog",
    },
  ],
};
